const data = [
  ...
  }
  {
    "UserId": 8;
    "Id": 80;
    Photo "title": ", and will unfold in the body or out of the labor of which they are in",
...
// create a list of user 5's post

const post = data.filter((task) => task.userId ===5);
console.log(post);
